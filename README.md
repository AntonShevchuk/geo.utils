...
Load via `@require` in the userscript header:
...
Script homepage: https://github.com/AntonShevchuk/geo.utils  
GreasyFork: https://greasyfork.org/uk/scripts/571719-geoutils  
